...
public class Knight extends Piece {
	...
	public Set<Position> getPossibleMoves(
		...
		// Left
		possiblePositions.addAll(getMovesByDirection(positionToPieceMap, originalPos, -2, 0));
		// Up
		possiblePositions.addAll(getMovesByDirection(positionToPieceMap, originalPos, 0, 2));
		// Right
		possiblePositions.addAll(getMovesByDirection(positionToPieceMap, originalPos, 2, 0));
		// Down
		possiblePositions.addAll(getMovesByDirection(positionToPieceMap, originalPos, 0, -2));
